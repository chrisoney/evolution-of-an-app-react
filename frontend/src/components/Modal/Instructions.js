    ...
    <div className={`${styles.info_container} ${styles.modal_version}`}>
      ...
      <div className={styles.mid_section}>
        <div className={styles.pnf_mode_description}>
          ...
          This app was built with an express backend and React frontend.
        </div>
      </div>
    </div>
  )
